...
public class LocalNavMeshBuilderAON : MonoBehaviour {

    public static LocalNavMeshBuilderAON Instance{ get; private set; }
    void Awake()
    {
        Instance = this;
    }
    ...
    public Vector3 m_Size = new Vector3(64.0f, 64.0f, 64.0f);
